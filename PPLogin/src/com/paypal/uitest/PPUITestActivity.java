...
//mock objects from Paypal client code as a test 
	 //final Pattern mPhoneValid = Pattern.compile("^\\+?[0-9]{7,14}$");
	 final Pattern mEmailValid = Pattern.compile("^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,} *$");
