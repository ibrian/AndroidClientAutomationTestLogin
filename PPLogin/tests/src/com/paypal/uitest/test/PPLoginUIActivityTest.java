...
public class PPLoginUIActivityTest extends
	...
	// API Unit Test cases here
	// To do: Add support of test data from files which can be input by QA
	 final String positiveTestCase = "liacao@paypal.com";
	 final String negativeTestCase = "@#$invalid@paypal.com";
	 final String stressTestCase = "adsfasfadfasfafdasfdafasfasfasfafsaadfdasfasfasfsdfadsfliacao@paypal.com";
	 
	    public void testPValidEmailAddressViaP2PvalidateEmail() {
	        assertTrue(mLoginActivity.validateEmail(positiveTestCase));
	      }
	 
	    public void testInvalidEmailAddressViaP2PvalidateEmail() {
	        assertFalse(mLoginActivity.validateEmail(negativeTestCase));
	      }
	 
	    public void testStressEmailAddressViaP2PvalidateEmail() {
	        assertTrue(mLoginActivity.validateEmail(stressTestCase));
	      }
	    
	    
	 // UI component test cases below
